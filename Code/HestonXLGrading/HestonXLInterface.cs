...
namespace HestonXL
{
    ...
    {      
        ...
        private static HestonParametersGrading ParseParameters(object guessModelParameters, double underlying, double riskFreeRate)
        {
            ...
            return new HestonParametersGrading(underlying, riskFreeRate, kappa, theta, sigma, rho, v0);
        }
